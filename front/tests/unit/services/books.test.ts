...
describe('getBooks', () => {
  it('should get books', async () => {
    jest.mocked(Axios.get).mockResolvedValue({ data: 'books' })
    await getBooks()
...
describe('getBook', () => {
  it('should get book', async () => {
    jest.mocked(Axios.get).mockResolvedValue({ data: 'book' })
    await getBook('id')
...
describe('saveBook', () => {
  it('should update book', async () => {
    jest.mocked(Axios.put).mockResolvedValue({ data: 'book' })
...
describe('scanBook', () => {
  it('should create book', async () => {
    jest.mocked(Axios.post).mockResolvedValue({ status: 201 })
