...
describe('Pagination', () => {
  it('should render current and max page', () => {
    ...
    render(<Pagination maxPage={10} pagination={pagination} limit={10} setLimit={jest.fn()} />)
  ...
  it('should go to first page when limit change', () => {
    const pagination = mockPagination({ canPrevious: true })
    const { rerender } = render(<Pagination maxPage={10} pagination={pagination} limit={10} setLimit={jest.fn()} />)
    rerender(<Pagination maxPage={10} pagination={pagination} limit={20} setLimit={jest.fn()} />)
    expect(pagination.first).toHaveBeenCalled()
  })
